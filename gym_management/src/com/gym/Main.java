            ...
            switch (command) {
                ...
                case "gui":
                    try {
                        ...
                        System.out.println("Sorry you can only open GUI once");
                    }
                    break;
                case "quit":
    ...
    private static void addFunction(int count) {
        ...
        switch (addCommands) {
            ...
            case "default":
                ...
                break;
            case "back":
                System.out.println("Going back to main console menu...");
                break;
        }
    }
...
//================================================ Save ================================================================
    private static void saveFunction() {
        ...
        System.out.println("\t* Saving in database is needs at least mongoDB community server");
        System.out.println("\t* Coping in file dont have neither of above options ");
        System.out.println("------------------------------------------------------------------");
