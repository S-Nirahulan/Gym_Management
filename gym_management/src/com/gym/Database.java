...
//============================================= Connecting to the database =============================================
    ...
    public static MongoDatabase database() {
        try {
            ...
            // The following commands is used to prevent from showing logs in console
            // (When connecting/Appending new documents/Retrieving)
...
//================================= Appending values to the database ===================================================
    public static void defaultDataBase(DefaultMember defaultMember){
        ...
        // Creating a DefaultMember collection in database/ locating the collection if it already exist
        MongoCollection<Document> defaultMemberCollection = database().getCollection("DefaultMembers");
        // Creating new document to append
        Document defaultMemberDocument = new Document()
                ...
                // It's auto generated by the program
        ...
        try {
            ...
            System.out.println("Invalid, Some Inserted details are already exist!");
        }
    }
...
//================================= Retrieving values from database ====================================================
    ...
    // I can use the following code more than one collection by making as method

    // The method is used to retrieve data from database
    // It's going to retrieve as document from specified collection
    // Later we can use the document to get the value(Member's name, Member's age) by their keys("_id","Name")
    public static ArrayList<Document> retriever(String collectionName){
        ...
        // Creating a Iterator to iterate through each documents in collection
        FindIterable<Document> iter = Collection.find();
        // Creating arraylist to add the documents to return them as array list
