...
//    Validation for the user inputs
//    Same methods but different no of parameters
...
//===================================== Verification for MyGymManager class ============================================
    ...
    // All string value's first letter will be changed to capital It will be easy to compare and sort two string without human error
    ...
    // Validating whether user inserting integers values or not by hasNextInt
    // And looping until user enters correct input
    ...
    public static int ageLimitVerifier(String question,int min, int max){
        ...
        do {
            ...
            if (answer <min || answer >max){
                System.out.println("Invalid answer for the category, Please try again!!!");
            }
